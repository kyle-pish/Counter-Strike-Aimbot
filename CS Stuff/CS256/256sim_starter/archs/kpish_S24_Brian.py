#
# kpish_S24_Brian.py  --  Simulator class for 256sim.
#
...
class Simulator:
    ...
    def sb(self, src_reg1: int, src_reg2: int, mask: int) -> None:                             # SB
        self.dmem[self.regfile[src_reg2]] = self.regfile[src_reg1] & mask                           # Store data from src_reg1 --> dmem address in src_reg2
        self.PC += 1                                                                                # Increment the program counter for the next instruction
